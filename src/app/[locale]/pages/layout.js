...
const PagesLayout = ({ children }) => {
  return (
    <div className="xl:flex pattern items-start gap-5 px-3 py-5 space-y-5 md:space-y-0">
      <div className="bg-white w-full xl:w-[75%] border p-5 min-h-[100vh] rounded shadow-xl backdrop-blur-xl z-10">
        {children}
      </div>
